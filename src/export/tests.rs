    ...
    let results = [
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    time_wall_clock: Time::from_seconds(0.09),
                    time_user: Time::from_seconds(0.09),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(0.10),
                    time_user: Time::from_seconds(0.10),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(0.14),
                    time_user: Time::from_seconds(0.14),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
        ...
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    time_wall_clock: Time::from_seconds(2.0),
                    time_user: Time::from_seconds(2.0),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(3.0),
                    time_user: Time::from_seconds(3.0),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(4.0),
                    time_user: Time::from_seconds(4.0),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
...
fn test_markup_export_auto_s() {
    let results = [
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    time_wall_clock: Time::from_seconds(2.1),
                    time_user: Time::from_seconds(2.1),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(2.2),
                    time_user: Time::from_seconds(2.2),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(2.3),
                    time_user: Time::from_seconds(2.3),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
        ...
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    time_wall_clock: Time::from_seconds(0.1),
                    time_user: Time::from_seconds(0.1),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(0.2),
                    time_user: Time::from_seconds(0.2),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(0.3),
                    time_user: Time::from_seconds(0.3),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
...
fn test_markup_export_manual_s() {
    let results = [
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    time_wall_clock: Time::from_seconds(2.01),
                    time_user: Time::from_seconds(2.01),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(2.02),
                    time_user: Time::from_seconds(2.02),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(2.03),
                    time_user: Time::from_seconds(2.03),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
        ...
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    time_wall_clock: Time::from_seconds(0.11),
                    time_user: Time::from_seconds(0.11),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(0.12),
                    time_user: Time::from_seconds(0.12),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
                Measurement {
                    time_wall_clock: Time::from_seconds(0.13),
                    time_user: Time::from_seconds(0.13),
                    time_system: Time::zero(),
                    peak_memory_usage: Information::from_bytes(1024),
                    exit_status: ExitStatus::default(),
                },
