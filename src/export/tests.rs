    ...
    let results = [
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    wall_clock_time: Second::new(0.09),
                    user_time: Second::new(0.09),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(0.10),
                    user_time: Second::new(0.10),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(0.14),
                    user_time: Second::new(0.14),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
        ...
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    wall_clock_time: Second::new(2.0),
                    user_time: Second::new(2.0),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(3.0),
                    user_time: Second::new(3.0),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(4.0),
                    user_time: Second::new(4.0),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
...
fn test_markup_export_auto_s() {
    let results = [
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    wall_clock_time: Second::new(2.1),
                    user_time: Second::new(2.1),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(2.2),
                    user_time: Second::new(2.2),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(2.3),
                    user_time: Second::new(2.3),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
        ...
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    wall_clock_time: Second::new(0.1),
                    user_time: Second::new(0.1),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(0.2),
                    user_time: Second::new(0.2),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(0.3),
                    user_time: Second::new(0.3),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
...
fn test_markup_export_manual_s() {
    let results = [
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    wall_clock_time: Second::new(2.01),
                    user_time: Second::new(2.01),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(2.02),
                    user_time: Second::new(2.02),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(2.03),
                    user_time: Second::new(2.03),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
        ...
        BenchmarkResult {
            ...
            measurements: Measurements::new(vec![
                Measurement {
                    wall_clock_time: Second::new(0.11),
                    user_time: Second::new(0.11),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(0.12),
                    user_time: Second::new(0.12),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
                Measurement {
                    wall_clock_time: Second::new(0.13),
                    user_time: Second::new(0.13),
                    system_time: Second::zero(),
                    memory_usage_byte: Byte::new(1024),
                    exit_code: Some(0),
                },
